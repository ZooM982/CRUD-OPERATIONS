const Dashboard = () => {
    return (
        <section id="dashboard">
           ...
           <div className="card rounded-0 v1">
                <div className="head-dash position-absolute top-0 start-1">
                ...
                <div className="footer-dash position-absolute bottom-0 end-0">
                    <h3 id="nombre"> </h3>
                </div>
           </div>
           <div className="card rounded-0 v2">
                <div className="head-dash position-absolute top-0 start-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="35" viewBox="0 0 28 35" fill="none">
                    <g clip-path="url(#clip0_17_55)">
                        <path d="M3.5 0H24.5C26.433 0 28 1.46904 28 3.28125V35L14 27.3438L0 35V3.28125C0 1.46904 1.56698 0 3.5 0ZM2.33333 31.1915L14 24.8113L25.6667 31.1915V3.28125C25.6667 2.67818 25.1433 2.1875 24.5 2.1875H3.5C2.85673 2.1875 2.33333 2.67818 2.33333 3.28125V31.1915Z" fill="#DDDDDD"/>
                    </g>
                    <defs>
           ...
           <div className="card rounded-0 v3">
                <div className="head-dash position-absolute top-0 start-1">
           ...
           <div className="card rounded-0 v4">
                <div className="head-dash position-absolute top-0 start-1">
